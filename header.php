...
<nav class="am-g am-g-fixed blog-fixed blog-nav">
    <a class="logo" href="/"><img src="<?php $this->options->themeUrl('images/logo.png'); ?>" alt="<?php $this->options->description() ?>"></a>
    ...
    <div class="am-collapse am-topbar-collapse" id="blog-collapse">
        <ul class="am-nav am-nav-pills am-topbar-nav">
            ...
            <?php while ($category->next()): ?>
                <li <?php if(!$this->is('index')&&($this->is('category', $category->slug)||$this->category==$category->slug)): ?>class="am-active"<?php endif; ?>><a href="<?php $category->permalink(); ?>" title="<?php $category->name(); ?>"><?php $category->name(); ?></a></li>
            <?php endwhile; ?>
        </ul>
